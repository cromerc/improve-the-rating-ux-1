    ...
    <div class="movie-list">
      <div class="movie-item" v-for="(movie, movieIndex) in movies" :key="movie.id">
        <div class="movie-item-image-wrapper">
          <div class="movie-item-image-star-wrapper">
            <div class="movie-item-image-star-content-wrapper">
              <div class="movie-item-image-star-icon-wrapper" :class="[
                movie.rating ? 'text-yellow-500' : 'text-gray-500',
              ]">
                <StarIcon class="movie-item-image-star-icon" />
                <div class="movie-item-image-text-icon">
          ...
          <div class="movie-item-rating-wrapper">
            ...
            <div class="movie-item-star-icon-wrapper">
              <button v-for="star in 5" :key="star" class="movie-item-star-icon-button" :class="[
                movie.rating !== null && star <= movie.rating ? 'text-yellow-500' : 'text-gray-500',
